        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemPicture = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartOrderDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StartDeliveryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndOrderDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartsItem_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId");
                    table.ForeignKey(
                        name: "FK_CartsItem_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "security",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => x.InvoiceId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartsItem_OrderId",
                table: "CartsItem",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CartsItem_UserId",
                table: "CartsItem",
                column: "UserId");
